...
import { root, isAncestor, isDescendant, get as _get, translate, isPath, set as _set, normalize } from '../utils/path.js';
/* for notify, reflect */
          ...
          if (!literal) {
            if (wildcard) {
              ...
              value = {
                ...
                value: pathValue,
                base: matches ? _get(data, name) : pathValue
              };
            } else {
